...
class SpeakPythonRecognizer:
	...
	def result(self, hyp, uttid):
		...
		self.debugMsg("final speech result: " + hyp, 1);
                #print  self.ai_module.respond(hyp); 
		self.quit();
	...
	def __init__(self, callback, appName, recogPath='./'):
		...
		#self.asr.set_property("jsgf", jsgfPath);
                self.asr.set_property('lm', os.getcwd()+ '/9079.lm') 
                #self.asr.set_property('lm', '/usr/share/pocketsphinx/model/en-us/en-us.lm.bin')
                self.asr.set_property('dict', os.getcwd() + '/9079.dic') 
                #self.asr.set_property('dict','/usr/share/pocketsphinx/model/en-us/cmudict-en-us.dict')
                #self.asr.set_property('hmm','/home/user1/cmusphinx/pocketsphinx/model/en-us/en-us')
                self.asr.set_property('hmm',  '/home/user1/rsai-offline/models/en-us-semi')
                #self.asr.set_property('hmm', '/home/user1/rsai-offline/models/cmusphinx-en-us-ptm-5.2') 
                #self.asr.set_property('hmm', '/home/user1/rsai-offline/models/cmusphinx-en-us-ptm-8khz-5.2') 
